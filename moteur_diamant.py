...
class Match:
    ...
    def __init__(self, nb_manches : int, nb_joueurs : int, noms_joueurs : list[str], IA):
...
def charge_IAs(joueurs : list[str], match : Match):
...
def partie_diamant(nb_manches : int, joueurs : list[str]):
    """
